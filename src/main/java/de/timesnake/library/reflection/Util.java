...
public class Util {
  ...
  public static void setInstanceField(Class<?> clazz, Object instance, String fieldName,
      Object value) {
    Field field = null;
    try {
      field = clazz.getDeclaredField(fieldName);
  ...
  public static Object invokeMethod(Class<?> clazz, Object handle, String methodName,
      Object... args) {
    Class<?>[] parameterClasses = new Class[args.length];
    for (int i = 0; i < args.length; i++) {
      parameterClasses[i] = args[i].getClass();
  ...
  public static Object invokeMethod(Object handle, String methodName, Class[] parameterClasses,
      Object... args) {
    return invokeMethod(handle.getClass(), handle, methodName, parameterClasses, args);
  }

  @SuppressWarnings("rawtypes")
  protected static Object invokeMethod(Class<?> clazz, Object handle, String methodName,
  ...
  public static Object getEnumConstant(Class<?> enumClass, String name) {
    ...
    for (Object o : enumClass.getEnumConstants()) {
      if (name.equals(invokeMethod(o, "name", (Object[]) new Class[0]))) {
        return o;
      }
    }
    return null;
